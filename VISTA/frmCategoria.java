...
public class frmCategoria extends javax.swing.JFrame {
    ...
    public void BuscarCategoria() {
        Categoria cat = null;
        try {
            cat = datosCategoria.buscarCategoriaNomCM(txtnombreCat.getText());
        } catch (Exception e) {
     ...
     public void BuscarCategoriaId() {
        Categoria cat = null;
        try {
            cat = datosCategoria.buscarCategoria(Integer.parseInt(jtfCodCategoria.getText()));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "ERROR:" + e.getMessage());
        }
        if (cat != null) {
            try {
                txtnombreCat.setText(cat.getNomcateg());
                jtfCodCategoria.setText(Integer.toString(cat.getCodcateg()));
                URL url = new URL(cat.getImagen());
                met.setObtener(url);
                met.Mostrar(JPImagenCat);
            } catch (MalformedURLException ex) {
    ...
    private void initComponents() {
        ...
        jlbCodCat = new javax.swing.JLabel();
        jtfCodCategoria = new javax.swing.JTextField();
        ...
        btnBuscarCat.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        jlbCodCat.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jlbCodCat.setText("Codigo Categoria :");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jlbCodCat, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(31, 31, 31)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtnombreCat, javax.swing.GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE)
                            .addComponent(jtfCodCategoria))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jlbCodCat)
                    .addComponent(jtfCodCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSalirCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalirCatActionPerformed
        ...
        frmMainMenu menu = new frmMainMenu(usr);
        dispose();
    ...
    private void btnAgregarCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarCatActionPerformed
        ...
        try {
            datosCategoria.insertarCategoria(cat);
    ...
    private void btnEditarCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarCatActionPerformed
        ...
        Categoria cat;
        try {
            cat = datosCategoria.buscarCategoriaNom(txtnombreCat.getText());
            cat.setImagen(ImagenURL);
            datosCategoria.actualizarCategoria(cat);
...
//        if (txtnombreCat.getText().compareTo("") != 0) {
        if (jtfCodCategoria.getText().compareTo("") != 0) {
...
//                BuscarCategoria();
    ...
    private void btnEliminarCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarCatActionPerformed
        // TODO add your handling code here:
        try {
            Categoria cat = datosCategoria.buscarCategoriaNomCM(txtnombreCat.getText());
            if (cat == null) {
                JOptionPane.showMessageDialog(null, "No existe");
            } else {
                datosCategoria.eliminarCategoria(cat.getCodcateg());
    ...
    private javax.swing.JLabel jlbCodCat;
    private javax.swing.JTextField jtfCodCategoria;
