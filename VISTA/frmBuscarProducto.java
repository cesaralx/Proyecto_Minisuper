    ...
    public frmBuscarProducto(final frmTransaccion frmt) {
        ...
        try {
            for (Producto p : datosProducto.mostrarProducto()) {
                ...
                String Datos[] = {String.valueOf(p.getIdProducto()), p.getNombre(), String.valueOf(p.getPreciounidad()), String.valueOf(p.getStock()), p.getCategoria().getNomcateg()};
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if ((fila > -1) && (columna > -1)) {
                    try {
                        ...
                        Producto u = datosProducto.buscarProducto(Integer.parseInt(String.valueOf(LProductos.getValueAt(fila, 0))));
